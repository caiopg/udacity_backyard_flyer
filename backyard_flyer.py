...
class BackyardFlyer(Drone):
    ...
    def local_position_callback(self):
        ...
        elif self.flight_state == States.WAYPOINT and self.local_position[0] > 0.95 * self.all_waypoints[self.next_waypoint-1][0] and self.local_position[1] > 0.95 * self.all_waypoints[self.next_waypoint-1][1]:
